import { type ActionDescriptor, type BatchPlayCommandOptions } from "photoshop/dom/CoreModules";
...
export async function batchPlayInModal(actionJSON: ActionDescriptor[], batchPlayOptions: BatchPlayCommandOptions = {}) {
